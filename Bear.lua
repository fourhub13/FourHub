...
local FolderName = "Four hub | Farm"
...
"•FourHub\n• Script by jokerbiel13 \n• Creation Date: 7-6-2026\n• Last updated date: 7-6-2026\n• Aura gun currently cannot shoot ships and Leviathans"
})
...
-- =========================================================
-- AUTO FISHING SYSTEM (Ported from FourHub)
-- =========================================================
        ...
        pcall(function()
            while wait(Sec) do
                if _G.Auto_Rainbow_Haki then
                    -- Copy logic Rainbow Haki từ file FourHub.txt (dòng 2058-2154) vào đây nếu cần
...
local MeleeCoords = {
    ...
    ["Dragon Talon (Dragon V2)"] = {
        Key = "BuyDragonTalon",
        NPC = "Uzoth",
        Pos = World3 and CFrame.new(5661, 1211, 865) or nil
    },
    ["Electric Claw (Electricity V2)"] = {
        Key = "BuyElectricClaw",
        NPC = "Previous Hero",
...
local SelectedMelee = "Dark Step (Black Legs)"
...
-- ========================================
v14:AddSection({"Buy Sea Event Craft Items"})

v14:AddButton({
    Name = "Craft Dragonheart",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CraftItem", "Craft", "Dragonheart")
        bearlib:Notify({Title = "Craft", Message = "I have crafted Dragonheart", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted Dragonstorm", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted DinoHood", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted SharkTooth", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted TerrorJaw", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted SharkAnchor", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted LeviathanCrown", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted LeviathanShield", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted LeviathanBoat", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted LegendaryScroll", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Craft", Message = "I have crafted MythicalScroll", Duration = 2})
    end
})
...
-- MUA HAKI, SORU, GEppo
-- ========================================
v14:AddSection({"Mua wear, Sol, Moonwalk"})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "I have bought Black Cape.", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "I bought the Swordsman Hat.", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Shop", Message = "Tomoe Ring has been purchased.", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Stats", Message = "Already Reset Stats", Duration = 2})
    end
})
...
v14:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Race", Message = "Already Random Race", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        if not RedeemRemote then
            bearlib:Notify({Title = "Error", Message = "Remote Redeem not found", Duration = 3})
            return
        end
        ...
        bearlib:Notify({Title = "Success", Message = "I've tried entering all the codes.", Duration = 3})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        LowCpu()
        bearlib:Notify({Title = "Optimization", Message = "Low CPU mode has been enabled.", Duration = 2})
    end
})
...
v15:AddButton({
    ...
    Callback = function()
        ...
        bearlib:Notify({Title = "Boats", Message = "The boat speed has been increased (client side).", Duration = 2})
    end
})
